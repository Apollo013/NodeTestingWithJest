...
describe("UserCredentialsDataAccess test suite", () => {
    let database: UserCredentialsDataAccess;
    ...
    beforeEach(() => {
        database = new UserCredentialsDataAccess();
    ...
    it("Should add user and return the id", async () => {
        ...
        const actualId = await database.addUser(someAccount);
    ...
    it("Should get user by id", async () => {
        ...
        const actualUser = await database.getUserById(someId);
    ...
    it("Should get user by name", async () => {
        ...
        const actualUser = await database.getUserByUserName(someAccount.userName);
